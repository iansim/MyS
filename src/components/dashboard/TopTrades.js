...
<ScrollView style={{flex: 1, backgroundColor: '#F1F0F1' }}>
              <View style={{flex: 1, flexDirection: 'column', backgroundColor: 'white', borderRadius: 5, alignItems: 'center', marginHorizontal: 10, height: 250, marginBottom: 10}}>
                ...
                <View style={{width: 320, borderWidth: 0.5, borderColor: 'rgba(222, 223, 226, 1)', marginHorizontal: 20, height: 1, marginVertical: 10}} />
                <View style={{flex: 1, flexDirection: 'row', alignItems: 'center'}}>
                  <View style={{flex: 1}}>
                    <Button
                      title='View Profile'
                      buttonStyle={{ width: 120, backgroundColor: 'rgba(222, 223, 226, 1)', borderRadius: 5}}
                  ...
                  <View style={{flex: 1}}>
                    <Button
                      title='Add User'
                      buttonStyle={{ width: 120, backgroundColor: 'rgba(113, 154, 112, 1)', borderRadius: 5}}
        ...
        <View style={{ backgroundColor: 'rgba(220,230,218,1)', width: 70, height: 28, borderRadius: 5, justifyContent: 'center', alignItems: 'center', flexDirection: 'row', marginLeft: 10}}>
          <Icon
            ...
            size={25}
          />
          <Text style={{color: 'green', fontSize: 13, marginLeft: 5}}>100</Text>
        </View>
      ...
      <View style={{height: 60, marginHorizontal: 20, marginTop: 10, backgroundColor: 'white', borderRadius: 5, alignItems: 'center', flexDirection: 'row'}}>
        ...
        <View style={{ backgroundColor: 'rgba(220,230,218,1)', width: 70, height: 28, borderRadius: 5, justifyContent: 'center', alignItems: 'center', flexDirection: 'row', marginLeft: 10}}>
          <Icon
            ...
            size={25}
          />
          <Text style={{color: 'green', fontSize: 13, marginLeft: 5}}>1000</Text>
        </View>
          <View style={{ backgroundColor: 'rgba(222,222,222,1)', width: 35, height: 28, borderRadius: 5, justifyContent: 'center', alignItems: 'center', marginHorizontal: 10}}>
            <Icon
              name='md-person-add'
